...
namespace QLThuVien.GUI
{
    public partial class FormAdmin : Form
    {
        ...
        private void FormAdmin_Load_1(object sender, EventArgs e)
        {
            ...
            panelShow.Controls.Add(new GUI.HomeAdmin());
        ...
        {
            panelShow.Controls.Clear();
            panelShow.Controls.Add(new GUI.FrmThemDauSach());
        }

        private void btnM_dsSDamuon_Click(object sender, EventArgs e)
        {
            panelShow.Controls.Clear();
            panelShow.Controls.Add(new GUI.DSSachMuon());
        ...
        {
            panelShow.Controls.Clear();
            panelShow.Controls.Add(new GUI.DSPhieuMuonNV());
        }
        private void btnDSNV_Click(object sender, EventArgs e)
        {
            panelShow.Controls.Clear();
            panelShow.Controls.Add(new GUI.DanhsachNV());
        }

        private void btnM_Nhapsach_Click(object sender, EventArgs e)
        {
            panelShow.Controls.Clear();
            panelShow.Controls.Add(new GUI.tk_sachnhap());
        }
        ...
        {
            panelShow.Controls.Clear();
            panelShow.Controls.Add(new GUI.DSSachCoSan());
        }

        public void btnAddNV_Click(object sender, EventArgs e)
        {
            panelShow.Controls.Clear();
            panelShow.Controls.Add(new GUI.Admin_ThemNV());
        }

        private void btnM_DSDG_Click(object sender, EventArgs e)
        {
            panelShow.Controls.Clear();
            panelShow.Controls.Add(new GUI.DanhSachDG());
        }
        ...
        {
            panelShow.Controls.Clear();
            panelShow.Controls.Add(new GUI.frmLapBBVP(MaQL));
        }

        private void btnM_regtkdg_Click(object sender, EventArgs e)
        {
            panelShow.Controls.Clear();
            panelShow.Controls.Add(new GUI.ThemDocgia());
        ...
        {
            panelShow.Controls.Clear();
            panelShow.Controls.Add(new GUI.QLNhap());
        }
        ...
        private void btnM_DSSachVP_Click(object sender, EventArgs e)
        {
            ...
            panelShow.Controls.Clear();
            panelShow.Controls.Add(new GUI.DSSachVP());
        }
